...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="col-md-6 col-xl-6 ">
         ...
         <div id="divTitulo" runat="server" style="padding:20px">
        ...
        <div class="row" style="justify-content:center">
            <div class="form-group" style="display: flex;padding-right:10px">
                <asp:Button ID="btnVolver" Text="Volver" type="button" class="btn btn-secondary" runat="server" OnClick="btnVolver_Click" />
            </div>
