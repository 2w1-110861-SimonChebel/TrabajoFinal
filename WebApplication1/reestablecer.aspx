            ...
            <div class="login col-md-6 col-xl-6">
                <form class="login-container" id="frmPrincipal">
                    ...
                    <div class="form-group">
                        <asp:TextBox runat="server" type="text" ID="txtEmail" class="form-control" name="login" placeholder="Email"></asp:TextBox>
                    </div>
                    ...
                    <div class="form-group centrarItemsDiv">
                        <asp:Button runat="server" ID="btnReestablecer" type="submit" class="btn btn-primary" Text="Confirmar" OnClientClick="return validarCampos();" OnClick="btnReestablecer_Click"></asp:Button>
                    </div>
