    ...
    public partial class devolucion : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (Validar.HayUnCampoSeleccionado(aControles))
            {
                ...
                List<VentaCliente> lstVentas = AdTransaccion.ObtenerVentasCliente(txtNroVenta.Text != "" ? Convert.ToInt32(txtNroVenta.Text) : 0, cli, usu, dtpFecha.Text,"",0,false,true,true);
                if (lstVentas != null)
                {
